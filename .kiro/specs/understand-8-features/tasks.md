...
- [ ] 1.2 Add the configuration keys and the 8.0 metric names, every default keeping today's behaviour
...
- [ ] 1.3 Extend the shared models, define the analysis-settings hash, and bump the cache schema
...
- [ ] 1.4 Give the contract project a git history and a base commit
...
- [ ] 1.5 Analyse with the SARIF and accuracy switches on request
...
- [ ] 1.6 Create databases from a commit and record a repository on a database
...
- [ ] 1.7 List and generate architectures through the wrapper
...
- [ ] 2.1 Probe each feature on the doctor's scratch project and store the answer
