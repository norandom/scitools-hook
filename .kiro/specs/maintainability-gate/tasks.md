...
- [ ] 2.3 Implement the settings loader with precedence, provenance and validation
...
- [ ] 3.1 Define the shared data models layer
...
- [ ] 3.2 Build the test infrastructure
...
- [ ] 4.1 (P) Implement threshold evaluation over elements and populations
